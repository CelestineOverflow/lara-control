...
class RobotScene {
  ...
  updateJoints() {
    if (this.laraArm.loaded) {
      this.laraArm.joint1.set(get(robotJoints).joint1);
      this.laraArm.joint2.set(get(robotJoints).joint2);
      this.laraArm.joint3.set(get(robotJoints).joint3);
      this.laraArm.joint4.set(get(robotJoints).joint4);
      this.laraArm.joint5.set(get(robotJoints).joint5);
