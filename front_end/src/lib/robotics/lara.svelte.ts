    ...
    constructor(scene: Scene) {
        ...
        manager.onLoad = () => {
            ...
            if (meshes.length > 0) {
                ...
                gtlfloader.load("gtlf/lara-head.glb", (gltf) => {
                    const model = gltf.scene;
                    //rotate 180 degrees around y axis
                    model.position.set(0, -0.1525, 0);
                    model.rotation.set(Math.PI, 0, 0);
                    lastMesh.add(model);
                    //add camera
                    this.camera = new PerspectiveCamera(61, 1280/720, 0.1, 1000);
                    ...
                    this.camera.position.set(0, -0.262, -0.016);
