...
<div style="position: relative; width: 100%; height: 50%;" bind:this={container}>
	...
	<div
		...
		class="aspect-square h-50px w-50px rounded-lg border border-white bg-transparent p-2"
	>
		<Render />
	</div>
