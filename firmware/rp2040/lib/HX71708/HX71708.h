...
/*
Forked from
HX711 library for Arduino by bogde
This is specific for the HX71708 24-bit ADC chip, witch support 10Hz, 20Hz, 80Hz and 320Hz data rate.
*/
...
//  supported values for set_frequency()
const uint8_t HX71708_FREQUCUENCY_10 = 128;  //  10Hz
const uint8_t HX71708_FREQUCUENCY_20 = 64;    //  20Hz
const uint8_t HX71708_FREQUCUENCY_80 = 32;    //  80Hz
const uint8_t HX71708_FREQUCUENCY_320 = 16;  // 320Hz
...
public:
  ...
  //  returns true  ==>  parameter frequency is valid
  //  returns false ==>  parameter frequency is invalid ==> no change.
  //  note that changing frequency/channel takes up to 400 ms (page 3)
  //  if forced == true, the frequency will be forced set
  //  even it is already the right value
  bool     set_frequency(uint8_t frequency = HX71708_FREQUCUENCY_10, bool forced = false);
...
private:
  ...
  uint8_t  _frequency     = 128;     //  default channel A
  long     _offset   = 0;
  float    _scale    = 1;
